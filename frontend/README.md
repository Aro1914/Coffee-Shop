...
This project depends on Nodejs  and Node Package Manager (NPM) (v6.14.14). Before continuing, you must download and install Node (v14.17.5) (the download includes NPM) from [https://nodejs.com/en/download](https://nodejs.org/en/download/).
